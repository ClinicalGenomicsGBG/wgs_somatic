    ...
    if normalid:
        ...
        rule excel_qc:
            input:
                ...
                msi_reduced = expand("{stype}/msi/{sname}_msi_reduced.txt", sname=tumorid, stype=sampleconfig[tumorname]["stype"]),
